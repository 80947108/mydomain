parcelRequire = function(e, r, t, n) {
	...
	"Bb20": [function(require, module, exports) {
		...
		function e() {
			var e = ["平生不修善果，只爱杀人放火。<br>忽地顿开金绳，这里扯断玉锁。<br>钱塘江上潮信来，今日方知我是我。", "给时光以生命<br>给岁月以文明", "你好，请多指教", "一望无际的迷雾中，<br>有人在寻找光明!", "你所热爱的<br>就是你的生活", "当你在凝视着网页的时候<br>网页也正在凝视着你", "热爱……", "平凡的日常正奇迹的发生着", "敬畏之心！", "赞美之心！", "我很好奇！","草木也知愁，韶华竟白头，叹今生谁舍谁收？<br>嫁与东风春不管，凭尔去，忍淹留。","*舒缓的现代音乐*"],
				i = o(0, e.length - 1);
			t("#slogan").html(e[i])
		}
