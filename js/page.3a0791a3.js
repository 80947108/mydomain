parcelRequire = function(e, r, t, n) {
	...
	"Bb20": [function(require, module, exports) {
		...
		function e() {
			var e = ["人生就像卫生纸，<br>没事尽量少扯。","往往是街边那些不起眼的店铺,才能做出真正的美味,而那些富丽堂皇灯红酒绿的大饭店……<br>我没吃过！", "命运的齿轮一点没转，<br>人生的链子倒是快掉完了。", "我对象说七夕陪我一天，<br>象说不行，动物园不放假！", "我的世界很小，小到每次一来消息<br>我就知道是哪几个b发来的", "突然有一股强烈的想要学习的欲望，<br>幸好我自制力强给压下去了!", "大便的时候你有可能会小便，<br>但你绝对不可能会在小便的时候大便！", "现在的雪糕都太贵了<br>我都是靠朋友的风凉话解暑", "一定要长得好看吗？<br>长得好笑不可以吗？", "如果我每天都混吃等死<br>那跟梦想成真有什么区别", "就算失败了九十九次<br>也要再努力一次凑个整数", "我的经济状况：有钱的时候败家<br>没钱的时候拜神！", "没有什么事情是到了某个年龄段必要去做<br>但是我到点下班了必须走！","别人聊天是聊着聊着就成了对象<br>我是聊着聊着她就有了对象","我很奇怪<br>你们都不用搬砖吗？","她长得漂亮就是你的青梅竹马<br>我长得丑就只是跟你一个村的是吧？","我一闭眼整个世界都黑了<br>一睁眼世界都亮了<br>我不是主角是什么","别人问我几岁，我说30，她惊叹我看起来好年轻，怎么做到的<br>我说多报几岁就可以","恋足癖属性大爆发<br>临时抱佛脚"],
				i = o(0, e.length - 1);
			t("#slogan").html(e[i])
		}
